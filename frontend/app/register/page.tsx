...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success("Account created! Welcome to TrustPass.");
    ...
    <div className="animated-bg min-h-screen flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="glass-strong rounded-2xl p-8">
          <h2 className="text-xl font-semibold mb-1" style={{ color: "#f1f5f9" }}>Create Account</h2>
          <p className="text-sm mb-6" style={{ color: "#64748b" }}>Start issuing verifiable credentials</p>
